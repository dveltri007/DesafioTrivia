...
namespace Trivia.Tests
{
    ...
    {
        private readonly TriviaPage triviaPage = new TriviaPage();
        private const int quantidadeListagem = 26;
        ...
        public static void ExtentStart()
        {
            ...
            string projectDirectoryWithOut = Directory.GetParent(workingDirectory).Parent.Parent.FullName;
            ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter($"{projectDirectoryWithOut}\\ExtentReports\\index.html");
        ...
        public void ThenContagemComSucesso()
        {
            try
            {
                ...
                test.Log(Status.Pass, "Realizando a Contagem de Paginação e Listagem");
            }
            catch (System.Exception ex)
            {
                test.Log(Status.Fail, ex.Message);
